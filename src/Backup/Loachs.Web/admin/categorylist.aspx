<%@ Page Language="C#" MasterPageFile="admin.master" AutoEventWireup="true" validateRequest="false" CodeFile="categorylist.aspx.cs" Inherits="admin_categorylist" Title="无标题页" %>
