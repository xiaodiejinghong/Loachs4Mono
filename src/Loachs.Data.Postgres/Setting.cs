    ...
    public class Setting : ISetting
    {
        public bool UpdateSetting(SettingInfo setting)
        {
            ...
            NpgsqlParameter[] prams = {
                                        PGSQLHelper.MakeInParam("@setting", NpgsqlDbType.Varchar,0,Serialize(setting)),
                                     };
        ...
        public SettingInfo GetSetting()
        {
            ...
            string cmdText = "select setting from Loachs_Sites limit  1 offset 0";


            string str = Convert.ToString(PGSQLHelper.ExecuteScalar(cmdText));
