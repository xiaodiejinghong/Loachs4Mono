...
namespace Loachs.Data.MYSQL
{
    ...
    public class MYSQLHelper
    {
       ...
       public static int QueryCount
       {
        ...
        //private static MySqlCommand MakeCommand(MySqlConnection conn, CommandType cmdType, string cmdText)
        //{
        ...
        /// <returns></returns>
        private static MySqlCommand MakeCommand(MySqlConnection conn, CommandType cmdType, string cmdText, MySqlParameter[] prams)
        {
            if (conn.State != ConnectionState.Open)
            {
                conn.Open();
        ...
        /// <returns></returns>
        public static MySqlParameter MakeReturnParam(string ParamName, MySqlDbType DbType, int Size)
        {
        ...
        /// <param name="Value">Param value.</param>
        /// <returns>New parameter.</returns>
        private static MySqlParameter MakeParam(string ParamName, MySqlDbType DbType, Int32 Size, ParameterDirection Direction, object Value)
        {
        ...
        /// <returns>object</returns>
        public static object ExecuteScalar(CommandType cmdType, string cmdText, MySqlParameter[] prams)
        {
            _querycount++;
            ...
            {
                MySqlCommand cmd = MakeCommand(conn, cmdType, cmdText, prams);
        ...
        /// <param name="prams">参数组</param>
        /// <returns>int</returns>
        public static int ExecuteNonQuery(CommandType cmdType, string cmdText, MySqlParameter[] prams)
        {
            _querycount++;
            System.Web.HttpContext.Current.Application["total"] = Convert.ToInt32(System.Web.HttpContext.Current.Application["total"]) + 1;
        ...
        /// <returns></returns>
        public static MySqlDataReader ExecuteReader(string cmdText, MySqlParameter[] prams)
        {
        ...
        /// <param name="prams">参数组</param>
        /// <returns></returns>
        public static MySqlDataReader ExecuteReader(CommandType cmdType, string cmdText, MySqlParameter[] prams)
        {
        ...
        public static DataSet ExecuteDataSet(CommandType cmdType, string cmdText)
        {
            //using (MySqlConnection conn = new MySqlConnection(ConnectionString))
            //{
            //    MySqlCommand cmd = MakeCommand(conn, cmdType, cmdText);
        ...
        /// <param name="prams">参数组</param>
        /// <returns>DataSet</returns>
        public static DataSet ExecuteDataSet(CommandType cmdType, string cmdText, MySqlParameter[] prams)
        {
            _querycount++;
            System.Web.HttpContext.Current.Application["total"] = Convert.ToInt32(System.Web.HttpContext.Current.Application["total"]) + 1;
